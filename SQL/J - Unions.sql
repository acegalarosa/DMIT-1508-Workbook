...
--A UNION allows us to combine the result set of two or more indivudual SELECT statements. For the UNION to work, however, the number, order and data type of the columns in the SELECT statements must match.
