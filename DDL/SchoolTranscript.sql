...
/* ----- Indexes ----- */
CREATE NONCLUSTERED INDEX IX_StudentCourses_StuentID
...
--3) Add a defualt constraint for the Status column of StudentCourses.
...
/*-----Other Odds and Ends-----*/
--sp_help Students -- Get schema informatin for the Students table
